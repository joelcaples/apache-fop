...
<xsl:stylesheet version="1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:axf="http://www.antennahouse.com/names/XSL/Extensions">
	...
	<xsl:template match="doc[@class='book'] | doc[@class=''] | doc[not(@class)]">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" axf:assumed-page-number="99" axf:assumed-page-number-prefix="">
	...
	<xsl:template match="doc/head">
		<fo:page-sequence master-reference="PageMaster-Cover" force-page-count="no-force">
			<fo:flow flow-name="xsl-region-body">
				<fo:block xsl:use-attribute-sets="cover.title" axf:outline-level="1">
		...
		<fo:page-sequence master-reference="PageMaster-TOC" force-page-count="no-force">
			<fo:flow flow-name="xsl-region-body">
				<fo:block xsl:use-attribute-sets="div.toc">
					<fo:block xsl:use-attribute-sets="toc" axf:outline-level="1" space-after="10pt">
						<xsl:choose>
	...
	<xsl:template match="body">
		<fo:page-sequence master-reference="PageMaster" initial-page-number="1">
			...
			<fo:flow flow-name="xsl-region-body"  axf:kerning-mode="contextual" axf:punctuation-spacing="0%" >
				<fo:block>
					<xsl:apply-templates/>
				</fo:block>
			</fo:flow>
