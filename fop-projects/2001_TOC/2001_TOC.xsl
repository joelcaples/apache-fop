...
<fo:block space-after=".25in">(((count(../issue) div ($MAX_ROWS*$MAX_COLS))+1) mod 2):<xsl:value-of select="(((count(../issue) div ($MAX_ROWS*$MAX_COLS))+1) mod 2)" /></fo:block-->
  ...
  <xsl:template name="volume_page">
    ...
    <fo:block margin=".5in">
      <fo:external-graphic height="2.25in" content-height="scale-to-fit" scaling="uniform" content-width="100%" src="url('./2001_Logo3.jpg')" />
    </fo:block>

    <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="12pt" color="#C5C6CC" margin=".5in">

    <xsl:choose>
            <xsl:when test="@volume_code='2001'">
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">2001: A Space Odyssey</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">#1-10</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
  ...
  <xsl:template name="issue">
    ...
    <fo:block font-size="8pt" color="#C5C6CC" margin-left=".5in" margin-right=".5in" margin-top=".25in">
