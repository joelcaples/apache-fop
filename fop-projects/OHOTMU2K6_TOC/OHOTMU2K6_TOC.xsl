...
<fo:block space-after=".25in">(((count(../issue) div ($MAX_ROWS*$MAX_COLS))+1) mod 2):<xsl:value-of select="(((count(../issue) div ($MAX_ROWS*$MAX_COLS))+1) mod 2)" /></fo:block-->
  ...
  <xsl:template name="volume_page">
    ...
    <fo:block margin=".85in">
      <fo:external-graphic height="1.5in" content-height="scale-to-fit" scaling="uniform" content-width="100%" src="url('./img/OHOTMU2K6.jpg')" />
    </fo:block>

    <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="10pt" color="#FBF211" margin=".5in">

    <xsl:choose>
            <xsl:when test="@volume_code='OHOTMU2K6_V1'">
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">All New Official Handbook Marvel Universe A-Z (2006)</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">All New Official Handbook of the Marvel Universe A-Z</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> #1-12</fo:block></fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">All New Official Handbook of the Marvel Universe Update</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> #1-4</fo:block></fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              <fo:block space-after=".1in" />
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">Marvel Atlas</fo:block></fo:table-cell>
    ...
    <!--fo:block margin=".85in">
      <fo:external-graphic height="7in" content-height="scale-to-fit" scaling="uniform" content-width="100%" src="url('./img/OHOTMU-80sMontage.jpg')" />
    </fo:block-->
  ...
  <xsl:template name="issue">
    ...
    <fo:block font-size="8pt" color="#1D1F19" margin-left=".5in" margin-right=".5in" margin-top=".25in">
