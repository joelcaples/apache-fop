...
<fo:block space-after=".25in">(((count(../issue) div ($MAX_ROWS*$MAX_COLS))+1) mod 2):<xsl:value-of select="(((count(../issue) div ($MAX_ROWS*$MAX_COLS))+1) mod 2)" /></fo:block-->
  ...
  <xsl:template name="volume_page">
    ...
    <fo:block margin=".25in">
      <fo:external-graphic height="2.25in" content-height="scale-to-fit" scaling="uniform" content-width="100%" src="url('./NewDefendersLogo.jpg')" />
    </fo:block>

    <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="12pt" color="#191970" margin=".5in">

    <xsl:choose>
            <xsl:when test="@volume_code='NEWDEF_1'">
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The New Defenders Volume 1</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">The New Defenders</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> #125-141</fo:block></fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
            </xsl:when>
            <xsl:when test="@volume_code='NEWDEF_2'">
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The New Defenders Volume 2</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">The New Defenders</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> #142-152</fo:block></fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">The Gargoyle</fo:block></fo:table-cell>
  ...
  <xsl:template name="issue">
    ...
    <fo:block font-size="8pt" color="#191970" margin-left=".5in" margin-right=".5in" margin-top=".25in">
