    ...
    <table width="1988px" height="3075px" border="1" cellspacing="0">
      <tr>
        <td class="volume_title" align="center" valign="top">
          ...
          <img src="FF_LOGO_mb.gif" />

          <br />
          
          <xsl:choose>
            <xsl:when test="@volume_code='FFBYRNE_1'">
              John Byrne's Fantastic Four Volume 1
              <br />
              <br />
              <table>
                <tr>
                  <td class="toc_summary">Fantastic Four</td>
                  <td class="toc_summary">&nbsp;#215-218</td>
                </tr>
                <tr>
                  <td class="toc_summary">&nbsp;</td>
                  <td class="toc_summary">&nbsp;#220-221</td>
                </tr>
                <tr>
                  <td class="toc_summary">&nbsp;</td>
                  <td class="toc_summary">&nbsp;#232-239</td>
                </tr>
                <tr>
                  <td class="toc_summary">Marvel Team Up</td>
                  <td class="toc_summary">&nbsp;#61-62</td>
                </tr>
                <tr>
                  <td class="toc_summary">Marvel Two-In-One</td>
                  <td class="toc_summary">&nbsp;#50</td>
                </tr>
              </table>
            </xsl:when>
            <xsl:when test="@volume_code='FFBYRNE_2'">
              John Byrne's Fantastic Four Volume 2
              <br />
              <br />
              <table>
                <tr>
                  <td class="toc_summary">Fantastic Four</td>
                  <td class="toc_summary">&nbsp;#240-253</td>
                </tr>
                <tr>
                  <td class="toc_summary">Fantastic Four Annual</td>
                  <td class="toc_summary">&nbsp;#17</td>
                </tr>
                <tr>
                  <td class="toc_summary">The Avengers</td>
                  <td class="toc_summary">&nbsp;#233</td>
                </tr>
              </table>
            </xsl:when>
            <xsl:when test="@volume_code='FFBYRNE_3'">
              John Byrne's Fantastic Four Volume 3
              <br />
              <br />
              <table>
                <tr>
                  <td class="toc_summary">Fantastic Four</td>
                  <td class="toc_summary">&nbsp;#254-267</td>
                </tr>
                <tr>
                  <td class="toc_summary">The Thing</td>
                  <td class="toc_summary">&nbsp;#2, 10</td>
                </tr>
                <tr>
                  <td class="toc_summary">Alpha Flight</td>
                  <td class="toc_summary">&nbsp;#4</td>
                </tr>
              </table>
            </xsl:when>
            <xsl:when test="@volume_code='FFBYRNE_4'">
              John Byrne's Fantastic Four Volume 4
              <br />
              <br />
              <table>
                <tr>
                  <td class="toc_summary">Fantastic Four</td>
                  <td class="toc_summary">&nbsp;#268-282</td>
                </tr>
                <tr>
                  <td class="toc_summary">Fantastic Four Annual</td>
                  <td class="toc_summary">&nbsp;#18</td>
                </tr>
                <tr>
                  <td class="toc_summary">The Thing</td>
                  <td class="toc_summary">&nbsp;#19</td>
                </tr>
              </table>
            </xsl:when>
            <xsl:when test="@volume_code='FFBYRNE_5'">
              John Byrne's Fantastic Four Volume 5
              <br />
              <br />
              <table>
                <tr>
                  <td class="toc_summary">Fantastic Four</td>
                  <td class="toc_summary">&nbsp;#283-295</td>
                </tr>
                <tr>
                  <td class="toc_summary">Fantastic Four Annual</td>
                  <td class="toc_summary">&nbsp;#19</td>
                ...
                <tr>
                  <td class="toc_summary">The Thing</td>
                  <td class="toc_summary">&nbsp;#23</td>
                </tr>
                <tr>
                  <td class="toc_summary">The Avengers Annual</td>
                  <td class="toc_summary">&nbsp;#14</td>
                </tr>
              </table>
              Fantastic Four 283-295  Fantastic Four Annual 19  The Thing 23  The Avengers Annual 14
            </xsl:when>
          </xsl:choose>
        </td>
      </tr>
