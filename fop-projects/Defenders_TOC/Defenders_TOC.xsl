...
<fo:block space-after=".25in">(((count(../issue) div ($MAX_ROWS*$MAX_COLS))+1) mod 2):<xsl:value-of select="(((count(../issue) div ($MAX_ROWS*$MAX_COLS))+1) mod 2)" /></fo:block-->
  ...
  <xsl:template name="volume_page">
    ...
    <fo:block margin="1.1in">
      <fo:external-graphic height="2.25in" content-height="scale-to-fit" scaling="uniform" content-width="100%" src="url('./Defenders_Logo3.jpg')" />
    </fo:block>

    <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="12pt" color="#000000" margin=".5in">
            ...
            <xsl:when test="@volume_code='DEFENDERS_V5'">
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Defenders Jan '81 - Jun '82</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">The Defenders</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> #92-108</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">Marvel Team-Up</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> #101, #111, #116</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">Captain America</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> #268</fo:block></fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
            </xsl:when>
            <xsl:when test="@volume_code='DEFENDERS_V6'">
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Defenders Jul '82 - Oct '83</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">The Defenders</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> #109-124</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">Marvel Team-Up</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> #119, #124</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">Avengers Annual</fo:block></fo:table-cell>
