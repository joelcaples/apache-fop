...
<fo:block space-after=".25in">(((count(../issue) div ($MAX_ROWS*$MAX_COLS))+1) mod 2):<xsl:value-of select="(((count(../issue) div ($MAX_ROWS*$MAX_COLS))+1) mod 2)" /></fo:block-->
  ...
  <xsl:template name="volume_page">
    ...
    <fo:block margin="2in">
      <fo:external-graphic height="2.25in" content-height="scale-to-fit" scaling="uniform" content-width="100%" src="url('./Who's_Who_logo.JPG')" />
    </fo:block>

    <fo:block text-align="start" space-after.optimum="3pt" line-height="14pt" font-family="sans-serif" font-size="12pt" color="#CD0000" margin=".5in">

    <xsl:choose>
            <xsl:when test="@volume_code='WHOSWHO_V1'">
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Who's Who in the DC Universe</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">Who's Who</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> I-XVII</fo:block></fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
            </xsl:when>
            <xsl:when test="@volume_code='WHOSWHO_V2'">
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">Who's Who</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> XVIII-XXVI</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">Who's Who Update '87</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block> #1-5</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="right">Who's Who Update '88</fo:block></fo:table-cell>
