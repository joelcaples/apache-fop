...
<xsl:stylesheet
  ...
  <xsl:variable name="MAX_ROWS">6</xsl:variable>
...
<fo:block space-after=".25in">count(../issue): <xsl:value-of select="count(../issue)" /></fo:block-->
    ...
    <fo:block margin=".5in">
      <fo:external-graphic height="5in" content-height="scale-to-fit" scaling="uniform" content-width="100%" src="url('./img/671066-beyonder_1_super.jpg')" />
    </fo:block>
  ...
  <xsl:template name="volume_page">
    ...
    <fo:block margin=".85in">
      <fo:external-graphic height="2in" content-height="scale-to-fit" scaling="uniform" content-width="100%" src="url('./img/Secret_Wars_II_Logo.jpg')" />
    </fo:block>
    ...
    <xsl:choose>
            <xsl:when test="@volume_code='SWII_1'">
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Secret Wars II Volume 1</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Alpha Flight #28</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Amazing Spider-Man #268</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Avengers #260-261</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Captain America #308</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Cloak and Dagger #4</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Daredevil #223</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Dazzler #40</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Doctor Strange #74</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Fantastic Four #282, #285</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Incredible Hulk #312</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Iron Man #197</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The New Mutants #30</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">ROM #72</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Secret Wars II #1-6</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Thing #30</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Uncanny X-Men #196</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Web of Spider-Man #6</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
            ...
            <xsl:when test="@volume_code='SWII_2'">
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Secret Wars II Volume 2</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
              ...
              <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-body>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Amazing Spider-Man #273-274</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Avengers #265-266, #274</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Fantastic Four #288, #316-319</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Micronauts #16</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The New Defenders #152</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The New Mutants #36, #37</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Peter Parker, The Spectacular Spider-Man #111</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Power Man and Iron Fist #121</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Power Pack #18</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Secret Wars II #7-9</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">Thor #363</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
                 <fo:table-row>
                    <fo:table-cell>
                      <fo:block text-align="center">The Uncanny X-Men #202-203</fo:block>
                    </fo:table-cell>
                  </fo:table-row>
